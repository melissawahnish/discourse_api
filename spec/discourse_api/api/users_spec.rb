...
describe DiscourseApi::API::Users do
  ...
  describe "#deactivate_user" do
    before do
      stub_put("http://localhost:3000/admin/users/15/deactivate?api_key=test_d7fd0429940&api_username=test_user").to_return(body: fixture("user_activate_success.json"), headers: { content_type: "application/json" })
    end
